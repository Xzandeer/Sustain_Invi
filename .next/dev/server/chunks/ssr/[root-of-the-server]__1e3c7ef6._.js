...
function KPICard({ title, value, icon, color }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: `rounded-lg p-6 ${colorClasses[color]}`,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
function generateForecast(movingAverages, days = 7) {
    const forecast = [];
...
function DashboardContent() {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    const [overallChartData, setOverallChartData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [categoryChartData, setCategoryChartData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            try {
                const itemsSnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDocs"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], 'items'));
    ...
    const generateOverallForecastChart = (salesList)=>{
        ...
        const labels = Object.keys(chartDays).map((date)=>new Date(date).toLocaleDateString('en-US', {
                month: 'numeric',
                day: 'numeric'
            }));
        const salesAmounts = Object.values(chartDays);
        const movingAverages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forecast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateMovingAverage"])(salesAmounts, 3);
        const forecast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forecast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateForecast"])(movingAverages, 7);
        const actualData = salesAmounts;
        const forecastLabels = [];
        for(let i = 0; i < 7; i++){
            const date = new Date(today);
            date.setDate(date.getDate() + i + 1);
            forecastLabels.push(date.toLocaleDateString('en-US', {
                month: 'numeric',
                day: 'numeric'
            }));
        }
    ...
    const generateCategoryForecastChart = (salesList)=>{
        const today = new Date();
        ...
        const allCategories = [];
        Object.values(categoryByDate).forEach((dayCategories)=>{
        ...
        allCategories.forEach((cat)=>{
            const movingAvg = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forecast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateMovingAverage"])(categoryTotals[cat], 3);
            const forecast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forecast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateForecast"])(movingAvg, 7);
            categoryForecasts[cat] = forecast[forecast.length - 1];
        });
        const topCategories = Object.entries(categoryForecasts).sort((a, b)=>b[1] - a[1]).slice(0, 3).map(([cat])=>cat);
        const colors = [
            '#f59e0b',
            '#ec4899',
            '#8b5cf6'
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        ...
                        children: "Overall Sales Forecast"
                    }, void 0, false, {
                        fileName: "[project]/app/dashboard/page.tsx",
                        lineNumber: 282,
                        columnNumber: 9
                    }, this),
                    overallChartData ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            position: 'relative',
                            height: '400px'
                        },
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        className: "text-xl font-bold mb-4 text-gray-900 dark:text-white",
                        children: "Category Demand Forecast (Top 3)"
                    }, void 0, false, {
                        fileName: "[project]/app/dashboard/page.tsx",
                        lineNumber: 297,
                        columnNumber: 9
                    }, this),
                    categoryChartData ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            position: 'relative',
                            height: '300px'
                        },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1e3c7ef6._.js.map