...
/* ------------------------------------------------------------------ */ /* ----------------------- DASHBOARD LOGIC --------------------------- */ /* ------------------------------------------------------------------ */ function DashboardContent() {
    ...
    const [aiForecast, setAiForecast] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadData = async ()=>{
            ...
            /* ------------ FIX: PARSE SALES SAFELY ------------ */ const salesList = salesSnap.docs.map((doc)=>{
                const d = doc.data();
                return {
                    id: doc.id,
            ...
            /* ------------ FIX: PARSE ITEMS SAFELY ------------ */ const itemsList = itemsSnap.docs.map((doc)=>{
                const d = doc.data();
                return {
                    id: doc.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9494d127._.js.map