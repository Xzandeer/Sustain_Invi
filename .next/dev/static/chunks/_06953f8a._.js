...
function DashboardContent() {
                ...
                "DashboardContent.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        const itemsList = itemsSnapshot.docs.map({
                            "DashboardContent.useEffect.fetchData.itemsList": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["DashboardContent.useEffect.fetchData.itemsList"]);
                        setItems(itemsList);
                        ...
                        const salesList = salesSnapshot.docs.map({
                            "DashboardContent.useEffect.fetchData.salesList": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["DashboardContent.useEffect.fetchData.salesList"]).sort({
                            "DashboardContent.useEffect.fetchData.salesList": (a, b)=>b.timestamp - a.timestamp
                        }["DashboardContent.useEffect.fetchData.salesList"]);
                        setSales(salesList);
    ...
    const generateOverallForecastChart = (salesList)=>{
        ...
        const movingAverages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forecast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMovingAverage"])(salesAmounts, 3);
        const forecast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forecast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateForecast"])(movingAverages, 7);
    ...
    const generateCategoryForecastChart = (salesList)=>{
        ...
        allCategories.forEach((cat)=>{
            const movingAvg = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forecast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMovingAverage"])(categoryTotals[cat], 3);
            const forecast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forecast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateForecast"])(movingAvg, 7);
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    overallChartData ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            position: 'relative',
                            height: '400px'
                        },
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    categoryChartData ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            position: 'relative',
                            height: '300px'
                        },
...
_s(DashboardContent, "4uyNgYPcmJ/z04dcC7GTSeJuQLM=");
_c = DashboardContent;
...
//# sourceMappingURL=_06953f8a._.js.map