...
function DashboardPage() {
                ...
                "DashboardPage.useEffect.unsubscribe": async (currentUser)=>{
                    ...
                    try {
                        ...
                        const itemsList = itemsSnapshot.docs.map({
                            "DashboardPage.useEffect.unsubscribe.itemsList": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["DashboardPage.useEffect.unsubscribe.itemsList"]);
                        setItems(itemsList);
                        ...
                        const salesList = salesSnapshot.docs.map({
                            "DashboardPage.useEffect.unsubscribe.salesList": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["DashboardPage.useEffect.unsubscribe.salesList"]).sort({
                            "DashboardPage.useEffect.unsubscribe.salesList": (a, b)=>b.timestamp - a.timestamp
                        }["DashboardPage.useEffect.unsubscribe.salesList"]);
                        setSales(salesList);
                        // Generate chart data
    ...
    const generateChartData = (salesList)=>{
...
_s(DashboardPage, "AUMWOjYrr/5Avi3u8MS/nLcFvuA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_1dc71038._.js.map