    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SalesPage.useEffect": ()=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], {
                "SalesPage.useEffect.unsubscribe": async (currentUser)=>{
                    if (!currentUser) {
                        router.push('/login');
                        return;
                    }
                    ...
                    try {
                        ...
                        const salesList = snapshot.docs.map({
                            "SalesPage.useEffect.unsubscribe.salesList": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["SalesPage.useEffect.unsubscribe.salesList"]).sort({
                            "SalesPage.useEffect.unsubscribe.salesList": (a, b)=>b.timestamp - a.timestamp
                        }["SalesPage.useEffect.unsubscribe.salesList"]);
                        setSales(salesList);
                    } catch (error) {
            ...
            }["SalesPage.useEffect.unsubscribe"]);
            return ({
                "SalesPage.useEffect": ()=>unsubscribe()
            })["SalesPage.useEffect"];
        }
...
_s(SalesPage, "xYhDsly3ZD86l1+qH+VZW6hhffI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_6e8a25ee._.js.map